...
<head>
    ...
    <link rel="stylesheet" href="../Styles/estiloB.css" type="text/css">
    ...
    <form name="validar" id="formuValidacion">
       ...
       <button type="submit" class="btn btn-primary btn-xl" id="validateButton" onClick="validacion();" onmouseup="location='../App/Trabajo.html'">Ingresar</button>
    </form>
